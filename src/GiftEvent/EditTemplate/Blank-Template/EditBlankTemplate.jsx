        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 text-center gap-8 mt-10">
            <div>
              ...
              <div className="mt-7">
                  ...
                  <h1>Section header 2</h1>
                  <EditTemplateLongInput
                    value={sanitizeContent(details && details.Statistics.section1paragraphy)}
                    onChange={(event) =>
            ...
            <div>
              ...
              <div className="mt-7">
                  ...
                  <h1>Section header 2</h1>
                  <EditTemplateLongInput
                    value={sanitizeContent(details && details.Statistics.section2paragraphy)}
                    onChange={(event) =>
            ...
            <div>
              ...
              <div className="mt-7">
                  ...
                  <h1>Section header 2</h1>
                  <EditTemplateLongInput
                    value={sanitizeContent(details && details.Statistics.section3paragraphy)}
                    onChange={(event) =>
            ...
            <div>
              ...
              <div className="mt-7">
                  <h1>Section header 1</h1>
                  <EditTemplateLongInput
                    value={sanitizeContent(details && details.Statistics.section4header)}
                    onChange={(event) =>
                  ...
                  <h1>Section header 2</h1>
                  <EditTemplateLongInput
                    value={sanitizeContent(details && details.Statistics.section4paragraphy)}
                    onChange={(event) =>
