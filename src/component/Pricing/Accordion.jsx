  ...
  const subscriptionPlans = [
    {
      ...
      features: {
        "Selling Online": [
          ...
          { name: "Remove DMP branding from landing page", available: false },
          { name: "Up to 500 monthly transactions allowed", available: true },
          { name: "7.5% fee per transaction", available: true },
        ],
        "Payment and Subscription": [
          { name: "Online payment gateway", available: true },
          { name: "DWP Wallet", available: true },
          { name: "Payment Analytics", available: true },
          { name: "Multi-currency module", available: false },
          { name: "Flexible pricing module", available: false },
        ],
        "Features & Integrations": [
          { name: "Appointment booking", available: true },
          { name: "Community & Chat", available: false },
          { name: "Online learning management solution", available: true },
          { name: "Invoicing & billing", available: true },
          { name: "1 (Tech) Admin user", available: true },
          { name: "Customer support ticketing module", available: false },
          { name: "Up to 1500 customer records", available: true },
          { name: "Email(in) App support", available: true },
          {
